$(document).ready(function () {
    ...
    $.getJSON(progress_api).done(function (data) {
        ...
        if (set_4_rest === 0) {
            ...
            set_4.find('.d-none').attr('src', 'img/landing/1.3_ticket_2_soldout.png');
            set_4.find('.d-block').attr('src', 'img/landing/1.3_ticket_2_mobile_soldout.png')
        }
        ...
        if (set_10_rest === 0) {
            ...
            set_10.find('.d-none').attr('src', 'img/landing/1.3_ticket_3_soldout.png');
            set_10.find('.d-block').attr('src', 'img/landing/1.3_ticket_3_mobile_soldout.png')
        }
