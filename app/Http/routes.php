...
Route::group(['domain' => 'master.'.$url,'middleware' => ['web']], function() {
    ...
    Route::group(['prefix' => 'tertp'], function(){
        Route::get('backmes','terTP\BackController@BackMes');
        Route::post('backmes','terTP\BackController@BackMes');
        Route::get('backme/{id}','terTP\BackController@BackMe');
        Route::delete('backme/{id}/delete','terTP\BackController@BackMeDelete');
        Route::post('backmes/{id}/sentcoupon','terTP\BackController@SentCouponCode');
        Route::post('backmes/{id}/sendUpdate','terTP\BackController@sendUpdate');
        Route::post('backmes/{id}/sendManageUpdate','terTP\BackController@sendManageUpdate');
        Route::post('backmes/{id}/infoUpdate','terTP\BackController@infoUpdate');
        Route::post('backmes/CanelCoupon','terTP\BackController@CanelCoupon');
        Route::get('backmenouse/xls','terTP\BackController@NotUseXls');
        Route::post('uploadxlsx','terTP\BackController@UploadXlsx2Db');
        // coupon
