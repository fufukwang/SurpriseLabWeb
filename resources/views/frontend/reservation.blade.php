...
@section('content')
<div class="main-container" style="padding:50px 15px 80px 15px;">
    <p>嗨！歡迎你的來訪！<br>無光晚餐已於 2016/12/31 結束快閃囉。</p>
    <p>想參加更多有趣的計畫<br>歡迎追蹤策辦團隊「驚喜製造」的 Facebook 與 Instagram</p>
    <p>祝大家驚喜常伴。</p>
    <div>
        <div>
            <ul>
                <li style="display: inline;">
                    <a target="_blank" href="https://www.facebook.com/surpriselabtw/">
                        <i class="fa fa-facebook" style="font-size: 30px;color:#a67b4e;padding:15px;"></i>
                    </a>
                </li>
                <li style="display: inline;">
                    <a target="_blank" href="https://www.instagram.com/surpriselabtw/">
                        <i class="fa fa-instagram" style="font-size: 30px;color:#a67b4e;padding:15px;"></i>   
                    </a>
                </li>
            </ul>
        </div>
