                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #FDFDFD;">
                            ...
                            <p style="color: #FDFDFD;"><span style="font-size:17px">@if($xls->l1>0)
時間有點限制票&nbsp;<br>
{{ $xls->l1 }}張<br>
@elseif($xls->a1>0)
暢行無阻票&nbsp;<br>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/703b108a2ad1da1887fe106f9/images/8f57060e-43bc-4b71-b545-956ecc905a6d.jpg" width="564" style="max-width:2009px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
