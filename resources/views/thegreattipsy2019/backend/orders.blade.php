@include('backstage.header',['title' => '微醺大飯店訂單設定'])
<!-- =======================
             ===== START PAGE ======
             ======================= -->
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="page-title">微醺大飯店訂單設定 </h4>
                    </div>
                </div>
                <!-- Page-Title -->
                            ...
                            <div class="table-rep-plugin">
                                <div class="table-wrapper">
                                    <div class="btn-toolbar">
                                        <div class="btn-group focus-btn-group"><form action="/thegreattipsy/pros">
...
@forelse ($order as $row)
                                            <tr id="tr_{{ $row->id }}">
                                                ...
                                                <td class="actions">
                                                    <a class="btn btn-primary btn-xs" href="/thegreattipsy/order/{{ $row->id }}/edit"><i class="fa fa-pencil"></i></a>
