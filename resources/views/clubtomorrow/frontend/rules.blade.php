                                    ...
                                    <div id="qa-according">
                                        <div class="card">
                                            ...
                                            <div id="qa1" class="collapse" aria-labelledby="qa1-header"
                                                ...
                                                <div class="card-body">
                                                    《明日俱樂部 Club Tomorrow》為驚喜製造 Surprise Lab. 繼《無光晚餐 Dining In The Dark》、《table for ONE 一人餐桌》與《微醺大飯店 The Great Tipsy》後，推出之第五號作品。延續微醺大飯店製作團隊，與進港浪製作再次攜手，推出全新沈浸式、互動式體驗作品。<br/>
                                                    <br/>
                                                    在明日俱樂部中，參與者將經歷一場結合表演、派對、音樂、酒飲、小點的大型體驗。參與者將隨著體驗中的七位角色，開始分流與相互角力，並在狂歡之中，迎來由所有人一同導向的結局。<br/>
                                                    <br/>
                                                    請記住，每個場次的結局，都將影響著下一場次的參與者。<br/>
                                                    <br/>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="qa6" class="collapse" aria-labelledby="qa5-header"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <br/>
                                                    明日俱樂部的場地，內含長窄的樓梯，無其他電梯動線與輔助，建議有相關考量者斟酌參加。
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="qa8" class="collapse" aria-labelledby="qa8-header"
                                                 data-parent="#qa-according">
                                                <div class="card-body">
                                                    《明日俱樂部》本質為表演，體驗中會有因為選擇而獲得數量不等的餐酒，屬於小點與飲品點綴，非餐飲體驗，請務必吃飽前來。<br/>
                                                    <br/>
                                                    明日俱樂部設有接待區，此區域提供額外付費之餐點與酒飲。參與者可於體驗前先抵達集合、吃點東西墊胃；或於體驗後在此停留休憩，延續與夥伴相聚的時刻。
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="qa12" class="collapse" aria-labelledby="qa12-header"
                                                 data-parent="#qa-according">
                                                <div class="card-body">
                                                    明日俱樂部內僅有接待區開放拍攝。表演開始後，因牽涉違反著作權法，未經許可，體驗過程中會統一連同手機寄物，無法帶入體驗場所內，也無法拍照錄影錄音，請務必留意。
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="presale-rules">
                                <div class="tab-content-inner">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            3. 依購買優先順序分三梯次（09/24、10/01與10/08)<br/>
                                            收到劃位序號信件。<br/>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            3. 序號扣抵同日期時段可一次分別填入多組劃位序號。如購買三張單人票券，可輸入三次序號完成扣抵。
                                        </li>
                                        <li>
                                            4. 同票種不同人的劃位序號可以一起使用，如：<br/>
                                            同樣購買單人票的Ａ先生序號與Ｂ小姐序號欲劃位同日期時段，適用第三點步驟完成劃位，不同票種則須分開劃位。
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            1. 劃位序號選擇的日期時段：10/30到11/24內所有的時段。
                                        </li>
                                        <li>
                                            2. 序號失效日期：10/30。
                                        </li>
                            ...
                            <div id="changeAndrefund">
                                <div class="tab-content-inner">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            3. 可更改之日期，以俱樂部回覆協助改期時尚有的日期提供更改。若因訂位狀況踴躍，導致無法更改至理想時段請見諒，建議劃位前先確認自己與朋友的行程，減少更改座位的可能性。
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            1. 體驗當日與體驗前一天超過服務時間後（晚上20:00）的申請無法取消與退費，但接受票券轉讓。
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            1. 至訂位後台查詢尚有空位的場次＋時段（建議準備三組）
                                        </li>
                                        <li>
                                            2. 提供訂位姓名、訂位信箱、劃位序號與欲更改的日期時段，至專屬信箱。
                                        </li>
                                        <li>
                                            3. 等待回信，以俱樂部回覆協助改期時尚有的日期為準。
                                        </li>
                                    </ul>
