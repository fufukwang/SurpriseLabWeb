                                    ...
                                    <div id="qa-according">
                                        <div class="card">
                                            ...
                                            <div id="qa1" class="collapse" aria-labelledby="qa1-header"
                                                ...
                                                <br/>
                                                以實境遊戲為主軸，參與者將成為玩家，進入由管理者Emily打造的遊戲世界。<br/>
                                                玩家會經歷一場一百二十分鐘的沈浸式體驗，結合扮演、遊戲、表演、餐酒、互動、參與、武打、音樂等多重元素。<br/>
                                                <br/>
                                                遊戲分三大階段：動盪的昨日、大戰的今日、未知的明日。<br/>
                                                <br/>
                                                在昨日，玩家可以自由穿梭場域，近距離觀看與拼湊這世界內七位角色的故事。<br/>
                                                在今日，玩家會加入五大陣營，參與陣營集會，不同陣營有著截然不同的餐飲搭配。<br/>
                                                <br/>
                                                接著，在五大陣營領導者的帶領下，玩家們會經歷一場大戰，為自己的陣營爭取勝利。每個陣營的獲勝條件都不盡相同，但贏家只會有一個。<br/>
                                                <br/>
                                                最後，這世界的明日，將由所有玩家一同決定 - 你們，會打造出什麼樣的明日呢？
                                            </div>
                                        </div>
