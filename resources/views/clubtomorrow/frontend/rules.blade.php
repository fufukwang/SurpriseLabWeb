                            ...
                            <div id="presale-rules">
                                <div class="tab-content-inner">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            3. 依購買優先順序分三梯次（11/12、11/19、11/26) 收到劃位序號信件。<br/>
                                    ...
                                    <ul>
                                        <li>
                                            1. 劃位序號選擇的日期時段：11/20到12/15內所有的時段。
                                        </li>
                                        <li>
                                            2. 序號失效日期：11/01（五）23：59分。
                                        </li>
                                    </ul>
                                    <h6 class="small-title">
                                        第二批玩家
                                    ...
                                    <ul>
                                        <li>
                                            1. 劃位序號選擇的日期時段：12/18到01/20內所有的時段。
                                        </li>
                                        <li>
                                            2. 序號失效日期：12/08（日）23：59分。
                                        </li>
                                    </ul>
                                    <ul>
                                        <li>
