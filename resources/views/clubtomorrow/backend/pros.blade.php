@include('backstage.header',['title' => '明日俱樂部營業日列表'])
<!-- =======================
             ===== START PAGE ======
             ======================= -->
                        ...
                        <div class="table-wrapper">
                            <div class="btn-toolbar">
                                <div class="btn-group focus-btn-group">
                                    <form action="/clubtomorrow/pros" autocomplete="off">
                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="table-rep-plugin">
                                <div class="table-wrapper">
                                    <div class="btn-toolbar">
                                        <div class="btn-group focus-btn-group" style="width: 100%"><form action="/clubtomorrow/pros/output/only" method="post">
                                            {{ csrf_field() }}
                                            <div class="form-group col-sm-1">
                                                <div class="col-sm-12">
                                                    <div class="input-group">
        ...
        $(function() {
            $('.btn-danger').bind('click', function() {
                ...
                if (confirm("確定要刪除此營業日?如有訂單將一併刪除")) {
                    $.ajax({
                        url: '/clubtomorrow/pro/' + id + '/delete',
                        method: 'delete',
                        dataType: 'json'
                    }).done(function(data) {
                        swal(data.message);
