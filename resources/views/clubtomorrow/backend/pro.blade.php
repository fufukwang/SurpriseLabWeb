@include('backstage.header',['title' => '明日俱樂部營業日編輯'])
<!-- =======================
===== START PAGE ======
======================= -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="row">
                                <div class="col-lg-10">
                                    <h4 class="m-t-0 header-title"><b>明日俱樂部建立營業日</b></h4>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="p-20">
                                        <form  data-parsley-validate novalidate method="post" action="/clubtomorrow/pro/{{ $pro->id or 0}}/update" class="form-horizontal">
{!! csrf_field() !!}
