                    ...
                    <div class="col-sm-12">
                        <div class="card-box">
                            <div class="table-rep-plugin">
                                <div class="table-wrapper">
                                    <div class="btn-toolbar">
                                        <div class="btn-group focus-btn-group" style="width: 100%"><form action="/dark2/uploadxlsx" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="form-group col-sm-1">
                                                <div class="col-sm-12">
                                                    <div class="input-group">
                                    ...
                                    <div>
                                        <p>
                                            範例檔案 : <a href="/example/dark2範例檔案.xlsx" target="_blank">xlsx 範例檔案</a>
                                        </p>
                                        <p>
                                            說明:<br />
