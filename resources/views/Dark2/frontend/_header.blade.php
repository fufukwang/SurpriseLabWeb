    ...
    <link rel="stylesheet" href="/dark2/style/css/print.css?v=0.2">
    <script src="/dark2/js/jquery-1.11.3.min.js"></script>
    @if(isset($index) && $index)
    <script src="/dark2/js/imagesLoaded.js"></script>
    <script src="/dark2/js/index.js"></script>
    @endif
    <script src="/dark2/js/main.js?v=0.1"></script>
    ...
    <meta property="og:title" content="無光晚餐2 DINING IN THE DARK 2" />
    <meta property="og:description" content="第二季限定快閃，預售計畫正式啟動 這裏黑暗無光，唯有你的舌尖，將被每道料理點亮" />
    <meta property="og:url" content="https://{{ $_SERVER['HTTP_HOST'] }}{{ $_SERVER['REQUEST_URI'] }}" />
    <meta property="og:site_name" content="無光晚餐2 DINING IN THE DARK 2" />
    <meta property="og:image" content="https://www.surpriselab.com.tw/images/share.jpg" />
    <meta property="og:type" content="website" />
    <meta name="description" content="第二季限定快閃，預售計畫正式啟動 這裏黑暗無光，唯有你的舌尖，將被每道料理點亮">
