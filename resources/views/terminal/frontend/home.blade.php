...
<head>
    ...
    <link rel="stylesheet" href="/terminalAssets/css/index.css?date=0208">
<!-- Google Tag Manager -->
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main class="background-wallpaper">
            ...
            <div class="project-wrap">
                <div class="project-tab-wrap">
                    ...
                    <div class="tab-content" id="projectTabContent">
                        ...
                        <div class="tab-pane fade" id="project-flight" role="tabpanel" aria-labelledby="project-flight-tab">
                            <div class="tab-content-inner">
                                <div class="project-slideshow">
                                    <div class="content-inner--slideshow-cover">
        ...
        <section class="section-wrap skip-background-light project-section" id="introduce">
            ...
            <div class="project-wrap">
                <div class="project-tab-wrap">
                    ...
                    <!-- Tab Content -->
                    <div class="tab-content" id="introduceTabContent">
                        ...
                        <div class="tab-pane fade show active" id="intro-surpriselab" role="tabpanel" aria-labelledby="intro-surpriselab-tab">
                            <div class="tab-content-inner">
                                <div class="heading-p">
                                    ...
                                    <p class="italic">期待在不遠的未來，<br>所有人都將變成驚喜製造。</p>
                                    <p>2019｜La Vie 台灣創意力 100 創意品牌首獎<br>2018｜Taiwan Design Best 100 年度設計團隊</p>
                                </div>
                                <div class="project-slideshow">
                                    <div class="content-inner--slideshow-cover">
                                        <div class="owl-carousel owl-theme" id="owl-train">
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="project-intro">
                                                    ...
                                                    <div class="project-desc">
                                                        ...
                                                        <br/><br/>
                                                        不管是曖昧、夫妻、朋友，甚至爸媽帶孩子來、孩子帶爸媽來，在這裡，每張餐桌都有故事。有人在這求婚、告白、談心，也有人在者說出心中想說很久的話。
                                                        <br/><br/>
                                                        你，會想與誰一同經歷黑暗？
                                                        <!-- 你將穿梭在如電影般的車廂間，遇見多位抱有遺憾、無法下車的乘客。微醺之間，你將逐步揭開列車上的秘密<br/><br/>
                                                        <i>──　願你安全到站</i> -->
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="project-intro">
                                                    ...
                                                    <div class="project-desc">
                                                        結合表演、空間、調酒、餐點、音樂，《微醺大飯店：1980s》試著讓喝酒不只是買醉、試著讓飯店不只是住宿，也試著，讓觀眾不只是看戲。
                                                        <br/><br/>
                                            ...
                                            <div class="item">
                                                ...
                                                <div class="project-intro">
                                                    ...
                                                    <div class="project-desc">
                                                        《明日俱樂部》的出現，與整個時代和社會緊密相關。人們因為不同的立場而分裂，為了捍衛信仰的價值而對抗。當我們想要的明天不盡相同，如何沒有輸贏？如何不再分裂？
                                                        <br/><br/>
                                                        進入這場遊戲的你，需在分裂的五大陣營中，找出讓所有人共同前往明日的可能。在權力面前，你會同意消除異己嗎？為了生存下去，你會向夥伴開槍嗎？每個人的決定，都將影響所有人的結局。
                                                        <br/><br/>
                                                        在混亂的世界中，你們將迎接怎樣的明天？
                                                        <!-- 你將穿梭在如電影般的車廂間，遇見多位抱有遺憾、無法下車的乘客。微醺之間，你將逐步揭開列車上的秘密<br/><br/>
                                                        <i>──　願你安全到站</i> -->
                                ...
                                <div class="project-slideshow">
                                    <div class="content-inner--slideshow-cover">
                                        <div class="owl-carousel owl-theme" id="owl-flight">
                                            ...
                                            <div class="item">
                                                <figure class="slideshow-card">
                                                    <img class="img-fluid owl-lazy" src="/terminalAssets/images/main/intro02_1.jpg" data-src="/terminalAssets/images/main/intro02_1.jpg" data-src-retina="/terminalAssets/images/main/intro02_1.jpg" alt="Eulogy">
                                                    <!-- <figcaption>
                                                        英國製作 ╳ 無光體驗 ╳ 聲音劇場
                                                    </figcaption> -->
                                                </figure>
                                            ...
                                            <div class="item">
                                                <figure class="slideshow-card">
                                                    <img class="img-fluid owl-lazy" src="/terminalAssets/images/main/intro02_2.jpg" data-src="/terminalAssets/images/main/intro02_2.jpg" data-src-retina="/terminalAssets/images/main/intro02_2.jpg" alt="DARKFIEKD RADIO">
                                                    <!-- <figcaption>
                                                        英國製作 ╳ 無光體驗 ╳ 聲音劇場
                                                    </figcaption> -->
                                                </figure>
                                            ...
                                            <div class="item">
                                                <figure class="slideshow-card">
                                                    <img class="img-fluid owl-lazy" src="/terminalAssets/images/main/intro02_3.jpg" data-src="/terminalAssets/images/main/intro02_3.jpg" data-src-retina="/terminalAssets/images/main/intro02_3.jpg" alt="SÉANCE">
                                                    <!-- <figcaption>
                                                        英國製作 ╳ 無光體驗 ╳ 聲音劇場
                                                    </figcaption> -->
                                                </figure>
            ...
            <div class="container-xl">
                <div class="row">
                    <div class="col-12">
                        <div class="b-content-wrap">
                            <div class="section-heading-wrap">
                                <h2 class="heading-title">站內規則</h2>
        ...
        <section class="section-wrap skip-background-light text-sction js-anchor-section" id="contact">
            <div class="container-xl">
                <div class="row">
                    <div class="col-12">
                        <div class="b-content-wrap">
                            <div class="section-heading-wrap">
                                <h2 class="heading-title">聯絡我們</h2>
                                <h3 class="heading-subtitle">Contact</h3>
                            </div>
                            <div class="text-wrap">
                                <p class="color-y200">
                            ...
                            <div class="cta-wrap">
                                <div class="btn-wrap">
                                    <a class="link-icon style-regular" href="https://www.facebook.com/surpriselabtw/" target="_blank">
                                        <i class="icon-fb"></i>
                                    </a>
                                    <a class="link-icon style-regular" href="https://www.instagram.com/surpriselabtw/" target="_blank">
                                        <i class="icon-ig"></i>
                                    </a>
                                </div>
                            </div>
        ...
        <section class="section-wrap skip-background-light text-sction" id="partners">
            <div class="container-xl">
                <div class="row">
                    <div class="col-12">
                        <div class="b-content-wrap">
