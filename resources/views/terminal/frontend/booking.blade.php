...
<head>
    ...
    <!-- Fontawesome -->
    <link rel="stylesheet" type="text/css" href="/terminalAssets/css/font-awesome/fontawesome.min.css"/>

    <!-- Select2 style -->
    <link rel="stylesheet" href="/terminalAssets/css/plugins/select2/select2.css"/>

    <!-- Custom CSS -->
    <link rel="stylesheet" href="/terminalAssets/css/style.css?v=0.1"/>
    <link rel="stylesheet" href="/terminalAssets/css/form.css"/>
...
<body class="loading">
            ...
            <form id="booking">
                ...
                <fieldset class="step step-1" title="無光晚餐 用餐登記">
                    ...
                    <div class="form-container">
                        ...
                        <p>&nbsp;</p>
                        <p class="prefix-step">
                            <span class="prefix">Step 1</span>輸入劃位序號<br/>
                        ...
                        <table class="filled-data">
                            ...
                            <tr class="coupon-code">
                                ...
                                <td>
                                    ...
                                    <div class="submit-coupon-error-message color-pink">一次劃位只能折抵單一票種的序號，請分別進行劃位</div>
                                </td>
                            </tr>
                            <tr class="coupon-code">
                                <td></td>
    ...
    <script src="/terminalAssets/js/plugins/jquery-ui.js"></script>
    ...
    <!-- Select2 script-->
    <script src="/terminalAssets/js/plugins/select2/select2.js?v=0.1"></script>
    ...
    <!-- Custom Js -->
    <script src="/terminalAssets/js/form.js?v=0.15"></script>
