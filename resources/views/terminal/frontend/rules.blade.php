                                            ...
                                            <div class="accordion rule-accordion-wrap" id="accordionFlushExample-4">
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="flush-4-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-4-headingOne" data-bs-parent="#accordionFlushExample-4">
                                                        <div class="accordion-body">
                                                            <p>《落日月台》為落日轉運站的戶外休憩場域，在此可以進行現場購票、票券兌換、拍照打卡，以及購買簡易小點與限量落日啤酒。</p>
                                                            <p>此處散發著落日的燈光氛圍，供大家在此休息等待、小酌聊天。 若你於體驗前提早抵達，歡迎在此打發時間；體驗後也能在此與同場次者小喝一杯、分享感覺、拼湊故事。 未購買體驗票券能滯留《 落日月台 》嗎？當然，此處開放給所有人，只要你想來，我們就歡迎。</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion rule-accordion-wrap" id="accordionFlushExample-5">
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="flush-5-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-5-headingOne" data-bs-parent="#accordionFlushExample-5">
                                                        <div class="accordion-body">
                                                            <p><a href="https://ec.citysuiteshotels.com/webhotel/0274/index?_rand=ptei15ntb3k" target="_blank">城市商旅 真愛館</a> - 無敵海景、緊鄰駁二，步行10 分鐘抵達落日轉運站</p>
                                                            <p>
                                                                此次轉運站指定下榻飯店！擁有絕佳視野，除了可以欣賞高雄的都市風貌，還能眺望海灣，將港區景觀盡收眼底，<br>
                                                                港區散散步，情調滿分，快來一趟最浪漫的落日小旅行。
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
