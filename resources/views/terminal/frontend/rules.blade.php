...
<head>
    ...
    <meta name="description" content="那些你感到疑惑的問題，與黑暗中可能遇到的狀況，都將在此一一說明。">
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="無光晚餐 Dining In The Dark - 問與答"/>
    <meta property="og:site_name" content="無光晚餐 Dining In The Dark - 問與答"/>
    <meta property="og:description" content="那些你感到疑惑的問題，與黑暗中可能遇到的狀況，都將在此一一說明。"/>
    ...
    <title>無光晚餐 Dining In The Dark - 問與答</title>
    ...
    <!-- OwlCarousel2 -->
    <link rel="stylesheet" href="/terminalAssets/css/owl2/owl.carousel.min.css"/>
    <link rel="stylesheet" href="/terminalAssets/css/owl2/owl.theme.default.min.css"/>

    <!-- Custom CSS -->
    <link rel="stylesheet" href="/terminalAssets/css/style.css?v=0.1"/>
    <link rel="stylesheet" href="/terminalAssets/css/rules.css?v=0.1"/>
...
<body class="loading">
                                ...
                                <div class="rule-according" id="qa-according">
                                    <div class="card">
                                        ...
                                        <div id="qa1" class="collapse" aria-labelledby="qa1-header"
                                            ...
                                            <div class="card-body">
                                                無光晚餐是⼀個在全⿊空間中，伸⼿不⾒五指，開眼無法適應，其餘感官⼤開，想像⼒噴發的餐飲體驗。「每次相遇，都是不約而同」，在無光中，吃飯固然重要，與你同行的那個人也同樣重要，有了他的陪伴，黑暗又怎會可怕？
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="qa4" class="collapse" aria-labelledby="qa4-header"
                                            data-parent="#qa-according">
                                            <div class="card-body">
                                                為了讓您更舒適放鬆地在⿊暗中⽤餐，⻄裝、套裝、吊嘎、睡⾐、裸體，以⾃⼰舒服的姿態出現都好。
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="qa7" class="collapse" aria-labelledby="qa7-header"
                                            data-parent="#qa-according">
                                            <div class="card-body">
                                                無光晚餐本身已經是個驚喜囉！因此不會特別為生日、紀念日等原因特別安排內容，如果想要在黑暗中送上為對方精心準備的禮物，請事先來信告知，我們很樂意協助遞送。
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="qa8" class="collapse" aria-labelledby="qa8-header"
                                            data-parent="#qa-according">
                                            <div class="card-body">
                                                我們會在行前通知信（體驗日七天前寄出）以及提醒簡訊（體驗當日寄出）中，告知你報到時間，請協助確認信箱與簡訊。<br/><br/>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="qa9" class="collapse" aria-labelledby="qa9-header"
                                            data-parent="#qa-according">
                                            <div class="card-body">
                                                過程中若因⿊暗嚇到吃⼿⼿，或需要使⽤洗⼿間，可隨時向服務⽣反應，將由服務⽣引導出場休息。若有幽閉恐懼症，建議衡量⾃身狀況報名活動。
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="qa10" class="collapse" aria-labelledby="qa10-header"
                                            data-parent="#qa-according">
                                            <div class="card-body">
                                                體驗時將分為兩人一組入座，若超過 2 人以上預約，我們可以安排你們坐在同一區域（依現場調整為主），但無法多人併桌。
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="item">
                        <div id="presale-rules">
                            ...
                            <div class="tab-content-inner">
                                ...
                                <div>
                                    <img class="img-fluid d-none d-sm-block" src="/terminalAssets/img/other/flow-tickets-for-two.png" alt="雙人套票說明">
                                    <img class="img-fluid d-block d-sm-none" src="/terminalAssets/img/other/flow-tickets-for-two-mobile.png" alt="雙人套票說明">
                                </div>
                                <br/>
                                <ol>
                                ...
                                <br/><br/>
                                <div>
                                    <img class="img-fluid d-none d-sm-block" src="/terminalAssets/img/other/flow-tickets-for-four.png" alt="雙菜單套票說明">
                                    <img class="img-fluid d-block d-sm-none" src="/terminalAssets/img/other/flow-tickets-for-four-mobile.png" alt="雙菜單套票說明">
                                </div>
                                <br/><br/>
                                <ol>
                    ...
                    <div class="item">
                        <div id="changeAndrefund">
                            ...
                            <div class="tab-content-inner">
                                ...
                                <p>
                                    若出現疫情、天災等不可抗力之因素，並由主管機關發布停止上班之訊息，《無光晚餐》也將公布暫停營業，協助客人改期或退費。
                                </p>
    ...
    <!-- OwlCarousel2 -->
    <script src="/terminalAssets/js/plugins/owl2/owl.carousel.min.js"></script>

    <!-- Custom Js -->
    <script src="/terminalAssets/js/rules.js?v=0.1"></script>
