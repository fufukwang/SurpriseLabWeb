                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 14px; padding: 14px;">
                                <a class="mcnButton " title="加入行事曆" href="https://calendar.google.com/calendar/event?action=TEMPLATE&text=落日轉運站 Sunset Terminal&dates={{ $gday }}&location=804高雄市鼓山區蓬萊路99號B10倉庫&details=&sf=tru" target="_blank" style="font-weight: bold;letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">加入行事曆</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/703b108a2ad1da1887fe106f9/images/bee124f7-75cb-6414-8d40-89dc6002348c.jpg" width="564" style="max-width:2251px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
