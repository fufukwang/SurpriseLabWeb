                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/703b108a2ad1da1887fe106f9/images/21bb448b-6ef6-7a47-960e-8afc525d5b65.jpg" width="564" style="max-width:2251px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
...
<?php
    ...
    if($pro){
?>
<span style="color:#DAA520">《微醺列車 </span></span><span style="color:#efaf50">THE GREAT TIPSY：BON VOYAGE</span><span style="font-size:14px"><span style="color:#DAA520">》班次</span><br>
<span style="color:#FFFFFF">將於 {{ \Carbon\Carbon::parse($pro->day)->format('m/d') }} {{ substr($pro->rang_start, 0,5) }}-{{ substr($pro->rang_end, 0,5) }} 啟動</span><br>
<br>
<?php } ?>
<?php
