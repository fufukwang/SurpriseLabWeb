                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/703b108a2ad1da1887fe106f9/images/e6718c50-b3e3-1963-0ff7-efd4564e8ba6.jpg" width="564" style="max-width:2251px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
...
?>
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #FFFFFF;font-size: 14px;line-height: 200%;text-align: center;">
                        
                            <div style="text-align: center;"><span style="font-size:14px"><span style="color:#FFFFFF">您預約的落日轉運站</span></span><br>
<br>
<span style="color:#DAA520"><span style="font-size:14px">《微醺列車 </span></span><span style="color:#efaf50">THE GREAT TIPSY：</span><span style="color:#efaf50">BON VOYAGE</span><span style="color:#DAA520"><span style="font-size:14px">》</span></span><span style="font-size:14px"><span style="color:#DAA520">班次</span><br>
<span style="color:#FFFFFF">將於 {{ \Carbon\Carbon::parse($pro->day)->format('m/d') }} {{ $start }}-{{ substr($pro->rang_end, 0,5) }} 啟動<br>
<br>
當天請於&nbsp;{{ $need }}&nbsp;到領票處領取車票<br>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/703b108a2ad1da1887fe106f9/_compresseds/61b1b3d4-5e9c-d727-2567-751db186ecbd.jpg" width="564" style="max-width:2251px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/703b108a2ad1da1887fe106f9/_compresseds/392ec3ae-2130-7ce3-1106-b153de368601.jpg" width="564" style="max-width:2251px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
