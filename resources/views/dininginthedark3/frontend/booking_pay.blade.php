    ...
    <main class="sections">
        ...
        <div class="container" id="bookingPage">
            ...
            <form id="booking" method="post">
                ...
                <!-- fieldsets -->
                <fieldset class="step step-1" title="無光晚餐 Dining In The Dark　賓客登記">
                        ...
                        <div class="form-group radio__button">
                            <div class="d-flex align-items-center flex-wrap">
                                ...
                                <a href="rules.html" target="_blank">
                                    無光晚餐 Dining In The Dark劃位與體驗規則
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="submit-page success" id="bookingSuccess" style="display:none;">
            <div class="container">
                ...
                <div class="feature-btn" style="text-align: center;">
                    <a class="btn-outline" href="index.html">關於無光晚餐 Dining In The Dark</a>
                </div>
            </div>
        </div>
