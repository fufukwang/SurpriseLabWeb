...
<body class="loading">
    ...
    <main class="sections fixed-scroll-anchor">
        ...
        <section class="section anchor-section" id="About">
            ...
            <div class="fullpage sec-intro" data-aos="fade">
                <div class="container">
                    ...
                    <p>
                        We don't see in darkness. We remember.<br/>
                        在沒有一絲光源的黑暗裡<br/>
                        重新發掘、探索、感受<br/><br/>
                        無光晚餐最終場座位已券數售罄<br/>
                        若你不巧錯過了，歡迎看看驚喜製造的最新快閃計劃<br/>
                        <span class="highlight">微醺大飯店 The Great Tipsy</span><br/>
                        希望能有機會，與微醺的你相見！
                    </p>
                </div>
            </div>

            <div class="fullpage sec-experience" data-aos="fade">
                <div class="container">
        ...
        <section class="anchor-section" id="Ticket">
            ...
            <!-- 預售劃位流程 -->
            <div class="container sec-ticket-process" data-aos="fade">

                <h3>預售劃位流程</h3>
                <div class="sub-title-wrapper">
                    <h4>
                        <span>Pre-Sale Schedule</span>
                    </h4>
                </div>
            </div>
