                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #D2D2D2;font-size: 14px;line-height: 150%;">
                            ...
                            <div style="text-align: center;">預約日期： {{ $day }}&nbsp;<br>
時段：{{ $time }}&nbsp;<br>
<br>
預約人數：{{ $pople }} 位&nbsp;<br>
<br>
<span style="color:#A9A9A9">葷食 {{ $meat_eat }} 位<br>
<span style="font-size:12px">（ 不吃牛肉 {{ $no_beef }} 位，不吃豬肉 {{ $no_pork }} 位 ）<br>
（ 不吃堅果&nbsp;{{ $no_nut_m }}&nbsp;位，不吃帶殼海鮮 {{ $no_shell }} 位 ）</span><br>
<br>
奶蛋五辛素 {{ $vegetarian }} 位<br>
<span style="font-size:12px">（ 不吃堅果 {{ $no_nut_v }} 位 ）</span></span><br>
<br>
地點<strong>：</strong><a href="https://goo.gl/maps/J8mMoQFdkL1mBPqs9" target="_blank">台北市大安區仁愛路四段345巷4弄3號</a><br>
<br>
<br>
<span style="color:#A9A9A9"><span style="font-size:13px">無光晚餐採按時段場次分批入場制，<br>
<strong><u>若遲到導致超過入場時間，會錯過部分體驗與餐點，<br>
並將無法入場，無法退費或打包</u></strong></span></span><br>
<br>
&nbsp;</div>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Times New Roman&quot;, Times, Baskerville, Georgia, serif; font-size: 18px; padding: 20px;">
                                <a class="mcnButton " title="加入行事曆" href="https://calendar.google.com/calendar/event?action=TEMPLATE&text=%E5%BE%AE%E9%86%BA%E5%A4%A7%E9%A3%AF%E5%BA%97&dates={{ $gday }}&location=台北市大安區仁愛路四段345巷4弄3號&details=&sf=true" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #D5D5D5;">加入行事曆</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://mcusercontent.com/703b108a2ad1da1887fe106f9/images/cca95499-57b8-f22a-b342-3a5563c398de.jpg" width="564" style="max-width:1080px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
...
<a href="mailto:dininginthedark@surpriselab.com.tw" target="_blank">dininginthedark@surpriselab.com.tw</a><br>
    ...
    <script type="text/javascript"  src="/39GmZgZtSeIG077c5w/7w7Y2VVDLuN1Ep/LFtobS0ANwE/MCZeQ/mEDazw"></script></body>
</html>
