...
<head>
    ...
    <link rel="stylesheet" href="/paris/css/home.css?2406111">
<!-- Google Tag Manager -->
    ...
    <main id="home">
        ...
        <section id="sec-about">
            ...
            <div class="info">
                ...
                <br>
                隱身於面具下、穿起高級訂製服<br>
                那些煩惱、包袱、擔憂，都能在此拋下<br>
                <br>
                從湖泊、花園、華爾滋到狂歡秀<br>
                那些奢華、神秘、奇幻，都能在這尋得<br>
                <br>
                來吧，邀上你想共舞的那個人<br>
                一起跳脫現實，跨越虛實界線<br>
                <br>
                    ...
                    <div class="col">
                        <div class="grid">
                            ...
                            <ul>
                                ...
                                <li><p>無障礙體驗、包場需求、其他特殊服務，請來信客服詢問<br><a class="hover-underline" href="mailto:lebaldeparis@surpriselab.com.tw">lebaldeparis@surpriselab.com.tw</a></p></li>
    ...
    <div id="enter-dialog">
        ...
        <div class="dialog-inner">
            <div class="dialog-content">
                <div class="img">
                    <img class="d-none d-md-block" src="/paris/img/enter-dialog.jpg" alt="無光晚餐 Dining In The Dark" />
                    <img class="d-block d-md-none" src="/paris/img/enter-dialog-m.jpg" alt="無光晚餐 Dining In The Dark" />
                </div>
