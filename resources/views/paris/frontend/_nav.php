    <header id="main-header" class="always-fixed fixed">
        <div class="flex justify-between items-center">
            ...
            <div class="flex">
                <a class="m" href="/lebaldeparis/en" style="color: #E28A8A; margin-right: 10px;"><img width="18" height="18" src="/paris/img/globe.png" style="display: inline-block; vertical-align: middle; margin-right: 6px; transform: translateY(-2px);" />English</a>
