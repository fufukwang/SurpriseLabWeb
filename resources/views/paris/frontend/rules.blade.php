...
<head>
    ...
    <title>舞會須知｜巴黎舞會 Le Bal de Paris de Blanca Li</title>
    ...
    <link rel="stylesheet" href="/paris/css/rules.css?240507">
<!-- Google Tag Manager -->
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main id="rules">
        <div class="tabs">
            <div id="tab-qa" class="tab-item active">問與答 Q&A</div>
            <div id="tab-change-refund" class="tab-item">退換政策 Change & Refund</div>
        </div>
        ...
        <div id="qa" class="tab-content">
            ...
            <div class="collapse-list">
                ...
                <div class="collapse-item">
                    <div class="item-title">非中文母語者可以參與體驗嗎？</div>
                    <div class="item-body">
                        <p>
                            當然可以！除中、英文外，巴黎舞會體驗亦提供法文、西班牙文、義大利文、德文，共6種體驗語言。<br>
                            若有相關需求，可於預約舞會時，備註體驗語言及對應人數。
                        </p>
                    </div>
                </div>
                <div class="collapse-item">
        ...
        <div id="change-refund" class="tab-content" style="display: none;">
            ...
            <ul>
                ...
                <li>退費入帳約需14 至25 個工作天，實際日期請依購票時使用信用卡銀行規定為主（特殊情況採ATM退費，入帳時間以客服人員回信為主）</li>
