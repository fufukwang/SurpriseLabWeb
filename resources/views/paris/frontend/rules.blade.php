...
<head>
    ...
    <link rel="stylesheet" href="/paris/css/rules.css">
</head>
<body>
    ...
    <main id="rules">
        ...
        <div id="change-refund" class="tab-content" style="display: none;">
            ...
            <p>不可抗力因素之更改訂位及退費辦法：若因天災、國際病毒、戰爭等不可抗力因素，由政府、該縣市主管機關發布停止上班、停演之訊息，本專案將暫停演出，並協助改期或全額退費</p>
            <br>
    ...
    <script src="/paris/js/rules.js"></script>
</body>
</html>