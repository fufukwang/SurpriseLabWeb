...
<head>
    ...
    <title>請重新預約｜巴黎舞會 Le Bal de Paris de Blanca</title>
    ...
    <link rel="stylesheet" href="/paris_en/css/booking.css?231020">
<!-- Google Tag Manager -->
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <main id="booking-fail">
        ...
        <div class="actions">
            <a class="p-btn primary" href="/lebaldeparis/booking_pay">重新購票</a>
        </div>
    </main>
