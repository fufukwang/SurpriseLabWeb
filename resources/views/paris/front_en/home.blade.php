...
<head>
    ...
    <link rel="stylesheet" href="/paris_en/css/home.css?240703">
<!-- Google Tag Manager -->
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <header id="main-header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex">
                <a class="mob-lang m" href="/lebaldeparis" style="color: #E28A8A; margin-right: 10px;"><img width="18" height="18" src="/paris/img/globe.png" style="display: inline-block; vertical-align: middle; margin-right: 6px; transform: translateY(-2px);" />中文</a>
    ...
    <main id="home">
        ...
        <section id="sec-about">
            ...
            <div class="info">
                ...
                Leave all your worries and burdens behind.<br>
                <br>
    ...
    <script src="/paris_en/js/home.js?240703"></script>
</body>
</html>