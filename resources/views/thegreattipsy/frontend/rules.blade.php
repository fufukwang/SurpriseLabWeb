                                ...
                                <div class="card">
                                    ...
                                    <div id="qa2" class="collapse" aria-labelledby="qa2-header"
                                        ...
                                        <div class="card-body">
                                            ...
                                            -等待：依照購票的優先順序分三梯次，<br/>購買02/10—03/03場次票券，將在01/23、01/30與02/03，依梯次分別寄送劃位信件。<br/>
                ...
                <div class="item">
                    <div id="presale-rules">
                        ...
                        <div class="tab-content-inner">
                            ...
                            <ul>
                                <li>
                                    此階段為第五批購票者，將依照購買優先順序分三梯次（05/01、05/08與05/14）收到劃位序號信件。若收信匣沒有看到，請到垃圾信件匣找尋，或來信詢問。
                                </li>
                                <!--li>
                            ...
                            <ul>
                                <li>
                                    劃位序號使用期限為05/15至06/16。
                                </li>
                                <li>
                                    未收到劃位序號前若申請退費，於05/14（含）前申請，可享全額退費。收到劃位序號後，於5/15至6/15（含）
