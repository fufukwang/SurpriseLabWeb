                                ...
                                <div class="card">
                                    ...
                                    <div id="qa2" class="collapse" aria-labelledby="qa2-header"
                                        ...
                                        <div class="card-body">
                                            ...
                                            -等待：依照購票的優先順序分三梯次，<br/>購買06/19—07/14場次票券，將在06/05、06/12與06/19，依梯次及購買順序分別寄送劃位信件。<br/>
                ...
                <div class="item">
                    <div id="presale-rules">
                        ...
                        <div class="tab-content-inner">
                            ...
                            <ul>
                                <li>
                                    此階段為第六批購票者，將依照購買優先順序分三梯次（06/05、06/12與06/19）收到劃位序號信件。若收信匣沒有看到，請到垃圾信件匣找尋，或來信詢問。
                                </li>
                                <!--li>
