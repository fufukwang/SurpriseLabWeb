...
<head>
    ...
    <link rel="stylesheet" href="css/rules.css?v=0.1"/>
</head>
<body class="loading">
<!-- Anchor menu -->
                            ...
                            <div id="qa-according">
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa2" class="collapse" aria-labelledby="qa2-header"
                                        ...
                                        <div class="card-body">
                                            ...
                                            -等待：依照購票的優先順序分兩梯次，12/26與01/02，依梯次分別寄送劃位信件。<br/>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa3" class="collapse" aria-labelledby="qa3-header"
                                         data-parent="#qa-according">
                                        <div class="card-body">
                                            同一個時段，總共會有約 30 位參與者一起抵達會場，但將拆成每 5-7 人一組，以小組的方式分別探索五個不同的房間。隨著時間的推演，小組會順著故事脈落進入下一個房間。
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa6" class="collapse" aria-labelledby="qa5-header"
                                         data-parent="#qa-according">
                                        <div class="card-body">
                                            「微醺」為進入體驗的唯一鑰匙，體驗過程中將提供三杯調酒，可以評估自身狀況，選擇舒適的方式進入微醺狀態。微醺大飯店無法更改此三杯調酒為無酒精飲料，不嗜酒者、因生理因素不便飲酒者可以酌量飲用，但唯有微醺，才能看見世界的全貌。
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa7" class="collapse" aria-labelledby="qa7-header"
                                         data-parent="#qa-according">
                                        <div class="card-body">
                                            體驗過程中將提供三道小點，可選擇葷食或是蛋奶素。餐點總份量約為 3-5 分飽，會建議各位在體驗前可先吃點東西，或是在體驗後再吃點東西。本體驗重點為「微醺」狀態下的旅程，體驗、調酒為主、餐點為輔。
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa9" class="collapse" aria-labelledby="qa9-header"
                                         data-parent="#qa-according">
                                        <div class="card-body">
                                            每一場次為30人，會在接待區集合一起出發，此階段的互動性較小，可能點頭之交那種互動。體驗開始後，會以每 5-7人為一組探索房間，此時的互動性較大，會一起參與房間中角色的故事，像是在同一包廂一起飲酒玩樂那樣。微醺大飯店中的角色們，會盡量輕鬆舒適的方式，引導各位一同參與。可以號招六位朋友一起獨樂樂，也可以兩兩併入新朋友認識一下，也可以隻身前往廣結良緣。
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa10" class="collapse" aria-labelledby="qa10-header"
                                         data-parent="#qa-according">
                                        <div class="card-body">
                                            有穿衣服就好，其他隨意。有些人穿著正裝禮服，也有些人穿著可愛睡衣，也有人帶著手電筒像是來冒險一樣。你可能會遇到各種人，而各種人也會遇見你。
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa12" class="collapse" aria-labelledby="qa12-header"
                                         data-parent="#qa-according">
                                        <div class="card-body">
                                            記得要比訂位時間提早十五分鐘抵達（若你的訂位時間為 18:30，請於 18:15 抵達）
                                            <br/><br/>
                                            也再次提醒，請務必準時抵達。
                                            <br/><br/>
                                            本體驗採時段場次分批入場，若遲到導致超過入場時間，將會錯過部分體驗甚至無法入場，也將不予以退費（可以想像是去看秀、看劇場表演，表演開始後將無法入場與退費)。而錯過的體驗、表演、食物、酒飲等，也無法回溯與外帶。為了您的權益，還請務必準時到場。
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa13" class="collapse" aria-labelledby="qa13-header"
                                         data-parent="#qa-according">
                                        <div class="card-body">
                                            若於劃位後，有更改日期、場次之需求，請於體驗日七天前寄信微醺大飯店客服信箱（若你的訂位日為 01/08，請最晚於 01/01 (含) 來信提出更改需求，詳細規則可見「<span class="to-change-and-refund">更改、退費事項</span>」，微醺大飯店工作人員，將以當下尚有的空位日期為你更換。請注意，因體驗涉及到事先安排，你將無法於體驗前六天與當天臨時調動場次，建議將票卷轉讓給朋友、家人。若有不可抗力因素，請來信微醺大飯店客服信箱。
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="qa16" class="collapse" aria-labelledby="qa16-header"
                                        ...
                                        <div class="card-body number-list">
                                            ...
                                            <p>
                                                ③ 若在體驗中身體不適，請隨時像現場工作人員反應。若因酒醉、嘔吐等因素造成設施損毀、環境髒亂，將會酌收修復費用、清潔費用，該費用與其核算方式將會另行通知。
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="item">
                    <div id="presale-rules">
                        ...
                        <div class="tab-content-inner">
                            ...
                            <ul>
                                <li>
                                    購買票卷者，會於微醺大飯店開啟時，依照購票的優先順序分兩梯次，12/26與01/02，收到劃位序號的信件。若收件匣沒有看到，可以到垃圾郵件桶找找，或是來信詢問。
                                </li>
                                <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    在訂位頁面第五步驟劃位序號欄位中，可分別填入多組劃位序號。如預訂兩組「暢行無阻票」，可輸入兩次序號，完成兩人扣抵；預定五組「時間有點限制票」，可輸入五次序號，完成五人扣抵；預定一組「四人沈醉票」，可輸入一次序號，完成四人扣抵。依此類推。
                                </li>
                                <li>
                                    不同人的劃位序號可以一起使用：如A先生的序號與B先生的序號，可以一起輸入劃位序號欄位，完成扣抵。也請特別注意票卷類型與其能劃位的時間，「時間有點限制票」僅能劃平日晚上與週末下午。
                                </li>
                            </ul>
                            ...
                            <ul>
                                <li>
                                    劃位序號使用期限為12/26至02/03。若後續有延長活動截止時間，會另外公布延長之劃位說明。
                                </li>
                                <li>
                                    尚未收到劃位序號前，若欲退費，於 12/31 (含)之前申請退費，可享全額退費。於收到劃位序號後，請於 01/01 (含)起至活動結束 02/03 (含) 前提出退費申請，扣除⾦流系統⼿續費 5% 後，將獲全額退費。若於活動結束 02/03 (含)前未申請退費，於活動結束後，將不另行退費。若後續有延長活動截止時間，會另外公布延長之退費說明。
                                </li>
                                <li>
                                    一旦使用序號完成劃位，劃位序號即失去效用，相關退費、更改座位需求，請參考「<span class="to-change-and-refund">更改、退費事項</span>」。
                                </li>
                            </ul>
                        </div>
                    ...
                    <div id="changeAndrefund">
                        ...
                        <div class="tab-content-inner">
                            ...
                            <ul>
                                ...
                                <li>
                                    請注意，你能夠更改的日期與時段，將與你預購時所購買的票卷種類有關。若你購買「時間有點限制票」，則只能更改至週間或週末中午時段。購買「暢行無阻票」、「四人沈醉票」，則可選擇所有可更改的日期更改。最終會以剩餘能更改的日期與時段為主，會由客服人員提供您可以更改的日期。
                                </li>
                                <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    體驗當日將無法取消與退費，也請務必準時到場。若會遲到請先來電告知（聯絡電話請見行前通知信，已於體驗日期前七日寄出至你的信箱），視當⽇狀況我們會盡⼒為你調整時間。
                                </li>
                                <li>
                                    本體驗採按時段場次分批入場，若遲到導致超過入場時間，將會錯過部分體驗甚至無法入場。其錯過的體驗、表演、食物、酒飲等，將無法回溯與外帶。為了您的權益，還請務必準時到場。
                                </li>
                            </ul>
