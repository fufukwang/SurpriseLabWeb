...
<nav class="anchor-wrapper">
    ...
    <ul>
        <li class="d-none active">
            <a class="smoothScroll welcome" href="#Welcome">Welcome</a>
        </li>
        <li>
            <a class="smoothScroll lobby" href="#Lobby">Lobby</a>
        </li>
        <li>
            ...
            <div class="row feature-wrapper justify-content-between no-gutters">
                <div class="col-auto d-flex justify-content-center flex-column">
                    ...
                    <div class="feature-btn">
                        <a class="btn-outline btn-outline-small smoothScroll" href="#About">飯店導覽</a>
                    </div>
                </div>
                <div class="col-auto d-flex justify-content-center flex-column">
                    <div class="feature-img">
        ...
        <div class="container" data-aos="fade">
            ...
            <div class="ticket">
                <p class="d-none d-sm-inline-block">
                    ...
                    01/16至03/24的場次已全數售罄，第一階段將告一段落<br/><br/>
                    <!--我們來回穿梭在各個城市，⼈們的好奇⼼讓我們得以實際存在<br/><br/>-->
                    <span class="highlight text-center">
                        微醺大飯店是否能延長，將來自於你的「選擇」<br/><br/>
                        若4/10前房客登記滿2500人，微醺大飯店則能以延續<br/>
                        我們將會加開 4/10 至 05/19 的場次，來迎接你的來訪<br/><br/>
                ...
                <p class="d-block d-sm-none">
                    ...
                    01/16至03/24的場次已全數售罄<br/>第一階段將告一段落<br/><br/>
                    <span class="highlight text-center">
                        微醺大飯店是否能延長<br/>將來自於你的「選擇」<br/><br/>
                        若4/10前房客登記滿2500人<br/>微醺大飯店則能以延續<br/>
                        我們將會加開 4/10 至 05/19 的場次<br/>來迎接你的來訪<br/><br/>
                    </span>
            ...
            <div class="sale-progress">
                ...
                <div class="sale-progress-info">
                    ...
                    <p class="info-text highlight-dark">
                        ...
                        *第一階段01/16-03/24的場次皆已售罄<br>
                        *若房客登記滿2500人，將加開4/11-5/19間的座位<br>
                        *若4/10未滿2500人，將全額退費，取消延長。<br>
                        *依實際情況延⻑或縮短日期
                    </p>
                </div>
            </div>
